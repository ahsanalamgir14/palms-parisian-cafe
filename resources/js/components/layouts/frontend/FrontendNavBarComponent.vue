    ...
    <header class="shadow-xs bg-white ff-header">
        <div class="container flex flex-col lg:flex-row items-center justify-between">
            <div class="w-full flex items-center justify-between gap-5 xl:gap-8 lg:justify-start lg:w-fit">
                <router-link :to="{ name: 'frontend.home' }" class="w-full">
                    <img class="w-32 logo-wb" :src="setting.theme_logo" alt="logo">
                    <div class="logo-mb text-center w-full flex justify-center">
                        <img class="w-32" :src="'/images/theme/mb_logo.png'" alt="logo">
                    </div>
                </router-link>
